    ...
    function handleEvent(name) {
        ...
        if (canHandleEvent(name)) {
            ...
            if (_.has(config.states, eventNode.toState)) {
                ...
                var onExitCurrentState = null;
                var onEnterTargetState = null;
                if (current !== eventNode.toState) {
                    // We are leaving one state and entering another.
                    var currentActionsNode = config.states[current]['actions'] || {};
                    var targetActionsNode = config.states[eventNode.toState]['actions'] || {};
                    onExitCurrentState = currentActionsNode.onExit;
                    onEnterTargetState = targetActionsNode.onEnter;
                }
